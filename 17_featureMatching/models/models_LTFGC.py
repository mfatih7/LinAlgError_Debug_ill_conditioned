...
class OANET_pool(nn.Module):
    def __init__(self, d, m):
        ...
        self.contextnorm = LTFGC_CN( self.d )        
...
class Order_Aware_Filter_Block(nn.Module):
    def __init__(self, m, d):
        ...
        self.contextnorm_1 = LTFGC_CN( self.d ) 
        ...
        self.contextnorm_3 = LTFGC_CN( self.d ) 
...
class Order_Aware_Network(nn.Module):
    def __init__(self, n, model_width, inner_dimension, m, CN_active_or_CN_inactive, residual_connections_active_or_residual_connections_inactive):        
        ...
        self.ResNet_7 = LTFGC_ResNet_Block( 2*self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_8 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_9 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_10 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_11 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
...
class Order_Aware_Network_Iterative(nn.Module):
    def __init__(self, n, model_width, inner_dimension, m, CN_active_or_CN_inactive, residual_connections_active_or_residual_connections_inactive):        
        ...
        self.layer_1_stage_1 = LTFGC_Layer_1( self.w, self.d )
        
        self.ResNet_1_stage_1 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_2_stage_1 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_3_stage_1 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        ...
        self.ResNet_4_stage_1 = LTFGC_ResNet_Block( 2*self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_5_stage_1 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_6_stage_1 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        
        self.layer_last_stage_1 = nn.Conv2d(in_channels=self.d, out_channels=1, kernel_size=(1,1), stride=(1,1) ) 
        
        #########################################################################################################################################################################################

        self.layer_1_stage_2 = LTFGC_Layer_1( self.w+2, self.d )
        
        self.ResNet_1_stage_2 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_2_stage_2 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_3_stage_2 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        ...
        self.ResNet_4_stage_2 = LTFGC_ResNet_Block( 2*self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_5_stage_2 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
        self.ResNet_6_stage_2 = LTFGC_ResNet_Block( self.d, self.d, self.CN_active_or_CN_inactive, self.residual_connections_active_or_residual_connections_inactive )
